...
function Mission() {
  return (
    <section className='border-2 p-2 max-w-3xl m-auto self-center mt-2 rounded-lg flex flex-col justify-center items-center py-8 px-4'>
        <h2 className='text-4xl font-semibold mb-4 text-center font-trebuchetMs text-gray-800'>Our Mission</h2>
        <p className='border-gray-300 font-trebuchetMs text-lg text-gray-700 text-center leading-relaxed'>LCAACST is for not-profit; non-governmental charity organization locally
